...
const getCommentByAuthorId = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const result = await commentService.getCommentByAllAuthorId(authorId as string)
    sendResponse(res, {
        success: true,
...
const getCommentByPostId = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const result = await commentService.getCommentByAllCommentId(postId as string)
    sendResponse(res, {
        success: true,
        statusCode: httpStatus.OK,
